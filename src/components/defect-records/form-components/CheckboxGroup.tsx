        ...
        {!isMobile && (
          <div className="flex flex-col items-center space-y-1">
            <Checkbox
              ...
              className="h-5 w-5"
            />
            <label htmlFor="nxs" className="font-medium uppercase text-lg">
              NXS
            </label>
          </div>
        )}
        ...
        {!isMobile && (
          <div className="flex flex-col items-center space-y-1">
            <Checkbox
              ...
              className="h-5 w-5"
            />
            <label htmlFor="dly" className="font-medium uppercase text-lg">
              DLY
            </label>
          </div>
        )}
        {!isMobile && (
          <div className="flex flex-col items-center space-y-1">
            <Checkbox
              ...
              className="h-5 w-5"
            />
            <label htmlFor="pln" className="font-medium uppercase text-lg">
              PLN
            </label>
          </div>
        )}
